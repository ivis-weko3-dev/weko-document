...
[9.8 非公開コンテンツをワンタイムアドレスを利用して共有したい 148](#非公開コンテンツをワンタイムアドレスを利用して共有したい)
...
<td>10</td>
<td>［メニューを最小化］ボタン</td>
<td>インデックスリンク、インデックスツリーなどのメニューが表示・非表示できます。</td>
</tr>
<tr class="odd">
<td>11</td>
<td>［Index Link］画面</td>
...
Shibbolethでログインする画面は、コンテンツファイルでの設定によって、JAIRO Cloudのログイン画面か、学認Embedded DSのログイン画面（[パターン①](#学認embedded-dsのログイン画面-パターン1)、[パターン②](#学認embedded-dsのログイン画面-パターン2)）が表示されます。
...
1)  [学認Embedded DSのログイン画面（パターン①）](#学認embedded-dsのログイン画面-パターン1)でログインします。
...
1)  [学認Embedded DSのログイン画面（パターン②）](#学認embedded-dsのログイン画面-パターン2) でログインします。
...
注：学認Embedded DS経由でのログイン時にGakuNin mAP機能からの情報に従って、ユーザーに対してロールおよびグループを付与します。

  - ロール名、グループ名の定義は設定ファイルに従って定義されます。 定義されたグループ名は指定の属性に含まれます。

  - 学認によるログインユーザーはGakuNin mAP機能により定義されたグループによるアクセス制御を行います。
...
インデックスに設定された雑誌情報を表示します。詳細については、システム管理ガイドの「4.2 雑誌情報を管理する」を参照してください。

![](media/media/image326.png)

| 項番 | 項目              | 説明                                   |
| --- | --- | ---|
| 1    | タイトル   | 雑誌情報の「タイトル」が表示されます。|
| 2    | 概要   | 雑誌情報の「概要」が表示されます。|
| 3    | プリント版ISSN/プリント版ISBN  | 雑誌情報の「プリント版ISSN/プリント版ISBN」が表示されます。|
| 4    | ISSN-L  | 雑誌情報の「ISSN-L」が表示されます。|
| 5    | URL  | 当該インデックスのURLが表示されます。|
...
1. アイテムリスト（一覧形式）
    ...
    | 項番 | 項目              | 説明                                   |
    | --- | --- | ---|
    | 1    | サムネイル   | アイテムタイプのサムネイルプロパティのオプションで「Show List」が"ON"になっているときに、アイテムリストへアップロードされたサムネイルファイルを表示します。<br>※アイテムに複数のサムネイルファイルがアップロードされている場合、アイテム詳細画面の１つ目のサムネイルファイルを表示します。|
    | 2    | 著者ID   | アイテムタイプの作成者プロパティのオプションで「Show List」が"ON"になっているときに、著者IDはアイコンで表示されます。|
    | 3    | Description   | アイテムタイプのDescriptionプロパティのオプションで「Show List」が"ON"になっているときに表示されます。クリックすると項目下部にDescription情報が表示されます。|
    | 4    | Files   | アイテムタイプのFilesプロパティのオプションで「Show List」が"ON"になっているときに表示されます。クリックすると項目下部にファイル情報が拡張子のリンク形式で表示されます（コンテンツファイルが無くURLのみ登録されている場合は"URL"と、拡張子が無いものは“unknown”と表示されます）。リンクをクリックすると、コンテンツファイルをダウンロードすることができます（コンテンツファイルが無くURLのみ登録されている場合はそのURLに遷移します）。また、登録されているコンテンツファイルが多い場合は、アイテムリストに「・・・」と表示されます。「・・・」をクリックすると、アイテム詳細画面が表示されます。|

   - Descriptionを表示する
        アイテムのDescription情報が表示されます。

    ![](media/media/image323.png)

    - Filesを表示する
        アイテムのコンテンツファイルや本文URL情報が表示されます。
    ...
    表示順や表示件数の説明については「3.3.1 簡易検索」を参照してください。
...
<td>8</td>
<td>ファイルのリンク</td>
<td><p>ファイルが添付されている場合はファイルのリンクを表示します。</p>
</td>
</tr>
<tr class="odd">
<td>9</td>
<td>「・・・」リンク</td>
<td><p>添付されているファイルが多い場合はこのリンクが表示されます。</p>
<p>このリンクをクリックすると、ファイルのリンクが展開されます。</p></td>
</tr>
</tbody>
</table>
...
DOI付与されているアイテムに対して、アイテムのステータスが非公開に変更できません。［非公開にする］ボタンをクリックすると、メッセージ「このアイテムはDOIが付与されているため非公開にできません。」が表示されます。
...
DOI付与されているアイテムに対して、アイテムを削除できません。また、DOI付与されているアイテムに対して、アイテムが直接紐づいているインデックスとその上位のインデックスについて、１つでも非表示の設定のものがある場合も削除できません。［削除］ボタンをクリックすると、メッセージ「このアイテムはDOIが付与されているため削除できません。」が表示されます。

![](media/media/image85.png)

図 4‑4エラーメッセージ「このアイテムはDOIが付与されているため削除できません。」
...
| 項番 | 項目                | 説明                                                        |
| -- | ----------------- | --------------------------------------------------------- |
| 1  | Versions             | バージョンの表示フォーマットは、「*yyyy-mm-dd hh:mm:ss.999999*」の形式で表示されます。 |
...
ダウンロード可能な年月日をファイル情報エリアに表示し、アクセス権が無い旨をプレビューエリアに表示します。
...
＊以下の機能は、＜利用申請機能 先行利用機関＞に提供している機能です。当機能の先行利用を申請していな機関は、利用できません。
...
・コンテンツファイルが課金ファイルである場合

設定されたロールごとにコンテンツファイルの価格が表示されます。 

また、以下の操作が行えます。課金ファイルの設定については「5.1.1　アイテムを登録する」を参照してください。 

![](media/media/image343.png)

未課金かつ購入可能なロールを所持している場合、[charge]ボタンが表示されます。 

[charge]ボタンを押下することで、コンテンツファイルを購入できます。 
...
5. GakuNin RDMプロジェクトアーカイブが公開状態にある場合、「Import to GakuNin RDM」ボタンを表示します。

![図4-20a　「Import to GakuNin RDM」ボタン](media/media/image101a.png)
図4-20a　「Import to GakuNin RDM」ボタン
...
| 2  | ［JPCOAR 1.0］ボタン   | クリックすると、JPCOAR 1.0.2形式で、OAI-PMH出力されます。     |
...
|   | ZIPリンク         | クリックすると、アイテムメダデータ資料をダウンロードできます。             |

#### コミュニティ

アイテムが所属するコミュニティを表示します。

![グラフィカル ユーザー インターフェイス 低い精度で自動的に生成された説明](media/media/image320.png)

図 427［コミュニティ］画面

表 4‑7［コミュニティ］画面の項目と説明
...
図 428 Information画面の統計(Stats)タブ選択状態
...
<td>1</td>
<td>ファイルエリア</td>
<td><p>ファイル名のリンクとライセンス情報、シークレットURLボタン（注）を表示します。</p></td>
</tr>
<tr class="odd">
<td>2</td>
<td>ファイル情報エリア</td>
...
※（注）シークレットURボタンは、管理者画面でシークレットURL機能を有効化した際に表示されます。この機能の詳細は以下を項目をご確認ください。

 [9.8 非公開コンテンツをワンタイムアドレスを利用して共有したい](#非公開コンテンツをワンタイムアドレスを利用して共有したい)
...
課金ファイルの場合、ファイル情報エリアにロールごとのコンテンツファイルの価格が表示される。
...
> 2. モーダル画面で指定したメールアドレスに特定のワークフローの編集画面リンクを含めたメール文を送信します。受信したメール文のリンクをクリックするとワークフローに定義されているアクション画面（アイテム登録画面など）に遷移して、ワークフローを登録して終了まで操作できます。
...
ここでは、ファイルの詳細画面に表示されている項目を説明します。

![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image327.png)  
図 430 ファイル詳細画面

表 4‑10ファイル詳細画面の項目と説明
...
<td>1</td>
<td>ファイル名情報欄</td>
<td>ファイル名リンクやチェックサムが表示されます。</td>
</tr>
<tr class="even">
<td>2</td>
<td>メタデータ表示欄</td>
<td>ファイルのメタデータが表示されます。</td>
</tr>
<tr class="odd">
<td>3</td>
<td>Version、Status情報表示欄</td>
<td>上部タブの切り替えによって、バージョンや閲覧回数等の等のステータス情報が表示されます。</td>
</tr>
</tbody>
</table>

#### ファイルを置き換える
ワークフロー画面を経由することなく、ファイルの置き換えが行える機能です。  

1.  アイテムの編集権限があるアカウントでファイル詳細画面を開いた場合、  
    ファイル名情報欄に「ファイル置き換え」ボタンが表示されます。  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image328.png)  
図 431「ファイル置き換え」ボタン

2.  ボタンを押下すると、エクスプローラーのファイル選択ウィンドウが開きます。  
    置き換えたいファイルを選択し、「開く」ボタンを押下してください。  
    ※元のファイルと同名のファイルのみ選択可能です  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image329.png)  
図 432 ファイル選択画面

3.  置き換え処理が完了すると、処理が完了した旨のメッセージ表示後、アイテム詳細画面に遷移します。  
    該当のファイルは選択したものに置き換えられ、  
    アイテムのバージョンが更新されます。  
    置き換え前の状態に戻したい場合、
    「バージョン削除」ボタンから該当のバージョンを削除することで、元の状態に戻すことができます。  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image330.png)  
図 432 ファイル置き換え完了後

#### ファイルを公開バケットへコピーする
該当のファイルを、Amazon S3等の公開バケットへコピーする機能です。  

1.  コピー先のバケットを取得/作成するために、  
    プロフィール情報にS3のアカウント情報設定が必要になります。  
    設定画面は画面右上のアカウント欄「▼」ボタン→「プロフィール」から開けます。  
    使用するS3アカウント情報を元に図の「6」～「9」の項目を設定してください。  
    （項目「8」：入力例「https://s3.{リージョン名}.amazonaws.com/」）  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image273.png)  
図 433 プロフィール画面

2.  アイテムの編集権限があるアカウントでファイル詳細画面を開いた場合、  
    ファイル名情報欄に「公開バケットへコピー」ボタンが表示されます。  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image331.png)  
図 434「公開バケットへコピー」ボタン

3.  ボタンを押下すると、コピー先バケットを選択するモーダルが開きます。  
    コピー先は、1.で設定したアカウント情報を元に取得された既存バケットから選択するか、  
    同アカウント情報を元に新規作成されるバケットとなります。  

    既存バケットを選択する場合、  
    対象のバケットは公開バケット(誰でも書き込み処理等行えるバケット)である必要があります。    
    （元ファイルがS3上に配置されている場合など、コピーを実行するために  
    元ファイル配置元のS3アカウントからコピー先のバケットに対して書き込み処理が行われるため）  
    事前に配置したいバケットの公開設定を行ってください。  

    新規作成バケットにする場合、ラジオボタンを「新規作成バケット名」に切り替えたうえで、  
    作成するバケット名を入力してください。  
    「実行」ボタン押下でコピー処理が実行されます。  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image332.png)  
図 435 バケット選択モーダル

4.  コピー処理が正常に完了すると、モーダル下部に  
    コピーされたファイルのURLが表示されます。URLを控えてください。  
    コピー先のファイルはWEKOの管理対象でないため、後からURLを確認することはできません。  
![グラフィカル ユーザー インターフェイス 自動的に生成された説明](media/media/image333.png)  
図 434 コピー完了後
...
##### researchmap からメタデータを自動入力する

researchmapからメタデータを自動で入力する手順を説明します。

1.	Select the IDでresearchmapを選択します。
［メタデータの自動入力］画面が以下のようになります。

![researchmapの情報入力画面](media/media/image140.png)

2.	parmalink、業績種別、業績IDを入力します。

ⅰ. parmalink

parmalinkとは、researchmapでの新規登録の際にご入力いただくリンク識別子のことを言います。「マイポータル」（researchmapの公開用ウェブページ）にアクセスするための研究者詳細ページURL末尾に付く文字列です。英数字記号混合で3～20文字で構成されており、以下の文字を含む場合、エラーとなります。
...
業績種別は、以下の6種に対応しています。
　論文、MISC、書籍等出版物、講演・口頭発表等、Works（作品等）、その他
デフォルトでは、「論文」が設定されています。

ⅲ. 業績ID

業績IDとは、researchmapに登録されている業績を特定するIDです。数字以外の文字を含むとエラーとなります。
上記ⅰ～ⅲのURL構成は、以下のようになります。

　https://researchmap.jp/{parmalink}/{業績種別}/{業績ID}

3.	[取得]ボタンをクリックします。
入力した情報に誤りがない場合、メタデータが自動入力されます。
自動入力の対象となるメタデータは、業績種別ごとに以下の表5-7のようになっています。

自動入力対象メタデータ一覧

|業績種別|メタデータ|
|---|---|
|論文|タイトル、作成者、内容記述、出版者、日付、収録物名、巻、号、開始ページ、終了ページ、言語、関連情報識別子、資源タイプ|
|MISC|タイトル、作成者、内容記述、出版者、日付、収録物名、巻、号、開始ページ、終了ページ、言語、関連情報識別子、資源タイプ|
|書籍等出版物|タイトル、作成者、内容記述、出版者、日付、ページ数、言語、関連情報識別子、資源タイプ|
|講演・口頭発表等|タイトル、作成者、内容記述、日付、会議記述、資源タイプ|
|Works（作品など）|タイトル、作成者、内容記述、関連情報識別子、資源タイプ|
|その他|タイトル、内容記述、資源タイプ|
...
> 代理投稿者として指定されたユーザは、アイテム登録者と同様に該当アイテムの登録(編集)権限が付与されます。 

> 代理投稿拡張機能が有効の場合は代理投稿者を複数指定することができます。

> [![](media/media/image345.png)]ボタンをクリックすると新規行が表示されます。

> ![](media/media/image346.png)

> 図511\[ユーザ情報入力項目\]画面 新規行

> \[![](media/media/image347.png)\]ボタンをクリックすると、行が削除されます。
...
以下機能は、＜利用申請機能 先行利用機関＞に提供している機能です。当機能の先行利用を申請していな機関は、利用できません。
この機能の利用に興味のある方はwekosoftware@nii.ac.jpへお問い合わせください

> 制限公開用アイテムタイプのファイルの情報は以下の通りです。
...
*本項目は、[アクセス]で[制限公開]を選択しているときに表示されます。
...
＜利用申請機能 先行利用機関＞に提供している機関には、以下のアクセス情報を持つアイテムを提供しております。
...
1.  表示されたItem Registration画面で、収録物識別子「ISSN、eISSN」を選択するまたは雑誌名を入力します。
2.  「![](media/media/image303.png)」ボタンをクリックするとポリシー情報のリンクが表示されます。
3.  リンクをクリックすると別タブでポリシー情報を確認できます。
...
<!--
<p>（補足）(6)ファイルの公開方法で［制限公開］を選択しても、このオプションは自動的に設定されません。［制限公開］については (6)を参照してください。</p>
-->
</td>
</tr>
</tbody>
...
> 図 5‑50同一アイテムが登録されている可能性がある場合の重複チェックメッセージ

  - > 識別子、タイトル、リソースタイプ、著者を入力した場合、登録済のアイテムであれば警告メッセージが表示されます。
    > 同一と思われる登録済みアイテムの詳細ページへのリンクが表示されます。リンクをクリックすると別タブで詳細画面が表示されます。

![](media/media/image305.png)

図 5‑51不正なフォーマットを入力した場合のエラーメッセージ

  - > 入力している値が定義されている選択肢に存在しない場合、エラーメッセージ「{} is not one of {}.」が表示されます。

![](media/media/image204.png)

図 5‑52入力している値が定義されている選択肢に存在しない場合のエラーメッセージ
...
図 5‑53 Javascriptエラーが発生する場合のエラーメッセージ

#### アイテムの利用申請方法を設定する。

・本機能は、試験的な機能です。JAIRO Cloud環境で提供しておりません

> アイテムに対する利用申請方法を設定する手順について説明します。

> ※ この機能はコンテンツファイルが未登録の場合のみ利用可能です。

> 1.  Item Registration画面にある、「アイテムに利用申請ワークフローを設定」チェックボックスをチェック状態にすると、ワークフローと利用規約のプルダウンが表示されます。

> 2.  表示されたワークフローおよび利用規約のプルダウンから利用申請方法と利用規約を設定します。  
    利用申請方法として、設定できるワークフローおよび利用規約については「表 5-19［アイテムの利用申請方法］の項目と説明」を参照してください。

> ![](media/media/image334.png)

> 表 5-19［アイテムの利用申請方法］の項目と説明

> | 項番 | 項目 | 説明 |
> |----|----|----|
> | 1 | \[ワークフロー\] | Admin&gt;WorkFlow&gt;WorkFlow Listで管理しているワークフローのうち「制限公開フラグ」が有効なものをリストに表示します。
> | 2 | \[利用規約\] | ［アクセス］で［制限公開］を選択している時に表示します。管理画面で登録した利用規約をリストで表示します。選択肢に「自由入力」を設け、選択した際はテキストエリアを表示します。

#### リクエストメール送信先を設定する

・本機能は、試験的な機能です。JAIRO Cloud環境で提供しておりません

> リクエストメール送信先を設定する手順について説明します。

> 1. 「リクエストボタンを表示」チェックボックスにチェックをいれます。

> ![](media/media/image335.png)

> 2. 表示されたItem Registration画面で、リクエストメール送信先の［<img src="media/media/image176.png" style="width:0.83333in;height:0.25in"/>］ボタンをクリックすると、作成者検索画面が表示されます。

> ![](media/media/image336.png)

> 3. 表示された［作成者検索］画面の［検索］テキストボックスに条件を入力した後、［<img src="media/media/image196.png" style="width:0.51042in;height:0.21267in" />］ボタンをクリックします。
> 条件検索を満たしている作成者が表示されます。

> ![](media/media/image198.png)

> ［作成者検索］画面の項目の説明については、［表 5-15［作成者検索］画面の項目と説明］を参照してください。入力ボタンを押下すると以下のリクエストメール送信先一覧にメールアドレスが反映されます。

> ![](media/media/image337.png)

> 表 5‑20［リクエストメール送信先］の項目と説明

> | 項番 | 項目 | 説明 |
> |----|----|----|
> | 1 | リクエストメール送信先一覧 | 設定したメールアドレス一覧が表示されます。 |
> | 2 | テキストボックス | メールアドレスを手入力します。Enterキーを押すことで手入力したメールアドレスを登録できます。 |
> | 3 | <img src="media/media/image263.png" style="width:0.54167in;height:0.28125in" /> ボタン | クリックすると、選択されているメールアドレスがリクエストメール送信先から削除されます。|

#### CRIS連携機能(researchmap連携機能)

researchmap連携を行う手順について説明します。

1. researchmapの左部にあるチェックボックスにチェックを入れます。

　researchmapの下部には、連携結果が表示されています。表示結果は以下の4種となっています。

　ⅰ. なし：一度も連携が行われていない状態を指します。

　ⅱ. Running：WEKO上での操作を終え、CRIS機関との連携を待機または行っている状態です。

　ⅲ. 成功：CRIS機関との連携に成功した状態です。完了した日付も表示されます。

　ⅳ. 失敗：CRIS機関との連携に失敗した状態です。失敗した日付も表示されます。

2. チェック後、当該ワークフローを完了します。

ワークフロー完了時に、自動連携が予約されます。

連携対象の著者に関しては、アイテムに入力してある著者（Creater,Contributer）を対象にします。
連携には事前に著者DBにparmalinkを登録しておく必要があります。

また、自動連携が行われるタイミングはデフォルトで毎日0時となっています。

![CRIS機関との自動連携](./media/media/images356.png)

（補足）researhmapとの連携を行う際には、以下のメタデータが必須項目となります。



必須メタデータ一覧

|jpcoar_mapping|メタデータ名|
|---|---|
|dc:title|タイトル|
|jpcoar:creator|作成者*1|
|datacite:date|日付*2|
|jpcoar:resource_type|資源タイプ*3|

*1：作成者は、著者DBに登録されておりresearchmapのparmalinkが設定されている作成者を指定する必要があります。

*2：アイテムの公開日とは異なる項目なので、別途設定が必要となります。

*3：指定できる資源タイプには限りがあります。指定可能資源タイプは以下の表5-21に記載されているものとなります。

指定可能資源タイプ一覧

|資源タイプ名|researchmapでの業績種別|
|---|---|
|article|publish_papers|
|journal article|publish_papers|
|conference paper|publish_papers|
|departmental bulletin paper|publish_papers|
|master thesis|publish_papers|
|doctoral thesis|publish_papers|
|learning object|misc|
|technical report|misc|
|book|books_etc|
|report|books_etc|
|musical notation|books_etc|
|video|books_etc|
|image|books_etc|
|sound|books_etc|
|map|books_etc|
...
図 5‑58エラーメッセージ「Please make sure the item type mapping is correct.」
...
アイテムを承認できるのは、基本的にリポジトリ管理者のロール権限を持つユーザーです。

リポジトリ管理者以外が承認できる場合は以下が存在します。

- 承認者に特定のロールが設定されていた場合：選択されているロールのユーザーが承認することができます。

- 承認者に特定のユーザーが設定されていた場合：選択されているユーザーが承認することができます。

・以下の事例は、＜利用申請機能 先行利用機関＞のみ利用可能です。当機能の先行利用を申請していな機関は、利用できません。

> - 承認者にプロパティが設定されていた場合：選択されているプロパティに設定されているユーザーが承認することができます。

> - 承認者に「アイテム登録者」が設定されていた場合：アイテムを登録した本人が承認することができます。

・以下の事例は、試験的な機能です。JAIRO Cloud環境で提供しておりません

> - 承認者に「リクエスト送信先」が設定されていた場合：アイテム登録の際に設定する「リクエスト送信先」のメールアドレスで登録しているユーザーが承認することができます。
> - 承認者が「リクエスト送信先」かつ、制限公開アイテムに対する「利用申請」、「二段階利用申請」ワークフローの場合：「利用申請の対象となった制限公開アイテムのリクエスト送信先のメールアドレス」のユーザーが承認することができます。

なお、承認者の設定方法はシステム管理マニュアルの「8.1フローを設定する」を参照してください。

登録者の承認待ちである登録するアイテムに対し、「却下(Reject)」、「保存(Save)」、「承認(Approval)」を行うことができます。

制限公開アイテムに対する「利用申請」、「二段階利用申請」ワークフローでの承認の際は、申請時に登録されたアイテムの表示形式に関係なくプレビュー機能が表示されます。

こちらの機能は、管理画面にてON/OFFの切り替えを行うことができます。
...
登録されたアイテムがOAアシストから登録された場合、そのステータスを連携する。
...
### アクティビティをTSVファイルに出力する

アクティビティをTSVファイルに出力する手順を説明します。 

1.[アクティビティ一覧]画面をシステム管理者またはリポジトリ管理者アカウントで表示します。 

2.出力したいアクティビティを［フィルターを追加］ボタンを用いて検索します。 

※手順の詳細は「(2)アクティビティの一覧をフィルターする」と同様となります。 

3.[ダウンロード]ボタン押下すると、TSVファイルが出力されます。 

![](media/media/image349.png)

図 5‑79 ダウンロードボタン

表 5-26［ダウンロード］の項目と説明 

| 項番 | 項目                | 説明                                                                                       |
|------|---------------------|------------------------------------------------------------------------------------------|
| 1    | [ダウンロード]ボタン | システム管理者、リポジトリ管理者のみ表示されます。画面に表示しているアクティビティと同じ検索条件のアクティビティをTSV形式のファイルでダウンロードします。 |

### アクティビティを削除する 

アクティビティを削除する手順を説明します。 

削除される際はそのアクティビティのTSVファイルがダウンロードされます。  
...
3.検索条件に一致するアクティビティをまとめて削除したい場合は、[ダウンロード]ボタンの隣にある[クリア]ボタンを押下します。１行だけ削除したい場合は、表示された行の[クリア]ボタンを押下します。 

4.確認ダイアログを[OK]を押下します。
...
| 項番 | 項目                          | 説明                                                                                                                         |
|------|-------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| 1    | [クリア]ボタン（[ダウンロード]ボタン横） | システム管理者、リポジトリ管理者のみ表示されます。画面に表示しているアクティビティと同じ検索条件のアクティビティをTSV形式のファイルでダウンロードし、そのアクティビティを削除します。 |
| 2    | [クリア]ボタン（行内）         | システム管理者、リポジトリ管理者のみ表示されます。選択したアクティビティをTSV形式のファイルでダウンロードし、そのアクティビティを削除します。 
...
>アイテム編集可能なユーザ権限を所有している場合、下記手順48~54以外にも、直接URL入力することでアイテム編集画面に遷移します。
>編集可能なユーザ且つ、当該アイテムが編集中ではない場合に編集画面に遷移でき、編集中の場合は図 6‑4のエラーが表示されます。
>権限を所有していない場合はログイン画面を表示します。
...
表 8-1［Communities］画面の項目と説明

| 項番 | 項目              | 説明                                   |
| -- | --------------- | ------------------------------------ |
| 1  | コミュニティロゴ     | コミュニティにロゴが設定されている場合に、その画像が表示されます。     |
| 2  | コミュニティ名    | クリックすると、そのコミュニティのトップページが表示されます。     |
| 3  | タグ情報    | コミュニティに設定された以下の主題情報がカンマ区切りで表示されます。<ul><li>主題</li><li>主題URL</li><li>タグスキーマ</li><li>言語</li></ul>     |
| 4  | 提供機関情報    | コミュニティに設定された以下の提供機関情報がカンマ区切りで表示されます。<ul><li>提供機関タイプ</li><li>提供機関名</li><li>言語</li></ul>     |

2. ［Communities］画面のリスト内からコミュニティ名のリンクをクリックします。

3. 選択したコミュニティのトップページが表示されます。
...
コミュニティのコンテンツポリシーを表示します。

1. コミュニティのトップページから［コンテンツポリシー］タブをクリックします。

![](media/media/image321.png)

2. コミュニティに設定されているコンテンツポリシーが表示されます。
...
| 6  | ［access key］テキストボックス                        | ファイル詳細画面から「公開バケットへのコピー」を行いたい場合、使用するS3アカウントの［access key］を入力します。                                      |
...
※ Personal Access Tokenは有効期間は無期限となります。取り扱いは十分にご注意ください。また、アカウント停止前には必ず廃棄してください。
...
### 非公開コンテンツをワンタイムアドレスを利用して共有したい

#### シークレットURL機能
<p>管理者画面でシークレットURL機能を有効化することで、シークレットURLを発行することができます。<br>
シークレットURLとは、投稿者（代理投稿者を含む）及びシステム、リポジトリ管理者が発行できるワンタムアドレスであり、このURLを知っている人は、誰でも対象のコンテンツファイルをダウンロードできます</p>

**<span style="color: red; ">本機能は、公開コンテンツ、ならびにサイトライセンス機能を利用してサイトライセンスユーザーに対してアクセス可能になっているコンテンツに対して、新たにアクセス権限を付与し、シークレットURLを通じたアクセスに制限する機能ではありません<span>。**

 Information画面のファイルエリアに「Secret URL」ボタンが追加されるのは、以下の条件を満たした場合となります。
 
 1.管理画面の制限公開画面にて、シークレットURLの表示を有効化している。
 
 2.アイテム投稿者・アイテムの代理投稿者・リポジトリ管理者・システム管理者がログインしている。

 3.当該ファイルを「公開しない」と設定している。または、ファイルが「オープンアクセス日を指定する」と設定し、指定日が未来日である。

 4.当該アイテムを登録先インデックスが「公開」である。
 
 5.当該アイテムのPublish StatusがPublishである。
 
![](media/media/images353.png)
 
図9-23 シークレットURL機能を有効化した場合のInformation画面ファイルエリア

シークレットURL機能を有効化した場合、以下の項目が追加されます。

表 9‑5 シークレットURL機能有効化時に表示される項目と説明
...
<td>1</td>
<td>シークレットURLボタン</td>
<td><p>このボタンをクリックすることで、シークレットURLを作成欄が表示されます。</p></td>
</tr>
<tr class="even">
<td>2</td>
<td>リンク名</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>シークレットURL作成時に付与したリンク名、リンク名を付与しなかった場合は当該URLの識別子が表示されます</p></td>
</tr>
<tr class="odd">
<td>3</td>
<td>作成日時</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>当該シークレットURLの作成日時が表示されます</p></td>
</tr>
<tr class="even">
<td>4</td>
<td>DL期限</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>当該シークレットURLの有効期限が表示されます</p></td>
</tr>
<tr class="odd">
<td>5</td>
<td>DL回数</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>当該シークレットURLのDL回数と残DL回数が表示されます</p></td>
</tr>
<tr class="even">
<td>6</td>
<td>削除ボタン</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>このボタンをクリックすると、削除確認モーダル画面が表示され、このモーダル画面内の削除ボタンをクリックすると、当該シークレットURLが削除されます。削除をやめる場合は閉じるボタンをクリックし、モーダル画面を閉じてください。</p></td>
</tr>
<tr class="odd">
<td>7</td>
<td>コピーボタン</td>
<td><p>シークレットURLが作成されている場合に表示されます。</p><p>このボタンをクリックすると、モーダル画面が表示され、発行したシークレットURLをクリップボードにコピーすることができます。モーダル画面上の閉じるボタンをクリックすることで、モーダル画面を閉じることができます。</p></td>
</tr>
</tbody>
</table>

「Secret URL」ボタンをクリックすると、シークレットURL編集作成欄が表示されます。

　![](media/media/images354.png)

図 9-24 シークレッㇳURLボタンをクリックし、シークレットURL作成欄を表示した状態

シークレットURL作成欄の各項目の内容は以下の通りです。

表 9‑6 シークレットURL作成欄の項目と説明
...
<td>1</td>
<td>作成ボタン</td>
<td><p>このボタンをクリックすることで、シークレットURLを作成します。</p></td>
</tr>
<tr class="even">
<td>2</td>
<td>メール通知 チェックボックス</td>
<td>このチェックボックスにチェックを入れ、作成ボタンをクリックすると、シークレットURLボタンをクリックしたアカウントに対してメールで通知します。</td>
</tr>
<tr class="odd">
<td>3</td>
<td>リンク名フィールド</td>
<td><p>作製するシークレットURLのファイル名を入力する。</p></td>
</tr>
<tr class="even">
<td>4</td>
<td>DL期限フィールド</td>
<td>作製するシークレットURLのDL期限をカレンダーから選択し、設定します。</td>
></tr>
<tr class="odd">
<td>5</td>
<td>DL回数フィールド</td>
<td>作製するシークレットURLのDL回数を設定します。</td>
</tr>
</tbody>
</table>
...
- ワークスペース一覧にはログインユーザーが所有するアイテムまたは代理投稿されたアイテムが表示されます。
...
| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 2  | 検索   | DOI、タイトル、雑誌名、会議名、資金名を検索します。   |
| 3  | ユーザ、所属情報 | ユーザ、所属情報を表示します。 |
| 4  | アイテム出力   | アイテムリストをTSVファイル出力します。   |
| 5  | アイテム登録   | アイテム登録画面に遷移します。   |
| 6  | グルーピング  | 表示を年単位で表示します。   |
| 7  | 絞り込み | 絞り込み条件設定画面に遷移します。 |
| 8  | 並び変え条件   | 出版年月、タイトル、アクセス数、ダウンロード数で並び替えができます。   |
| 9  | 並び替え順 | 昇順、降順を選択できます。 |
| 10  | ページング   | 表示数を20,50,100に変更できます。   |

表11-3 アイテム一覧（アイテムリスト左部分の説明）
![](media/media/image318.png)

| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 11  | 年度のラベル   | グルーピングを押下すると年度別に表示されます。   |
| 12  | 一括選択チェックボックス | アイテムリストを一括選択します。 |
| 13  | チェックボックス   | 選択するとアイテム出力ができます。   |
| 14-1  | お気に入りボタン(お気に入り登録済み)  | お気に入り状態を切り替えできます。  |
| 14-2  | お気に入りボタン(お気に入り未登録)   | お気に入り状態を切り替えできます。   |
| 15-1  | 既読未読切り替えボタン(未読状態) | 既読状態、未読状態を切り替えできます。 |
| 15-2  | 既読未読切り替えボタン(既読状態) | 既読状態、未読状態を切り替えできます。 |

表11-4 アイテム一覧（アイテムリストの説明）
...
| 17  | 未読バッジ  | 未読状態を表示します。   |
| 18  | 雑誌名、会議名 | 雑誌名、会議名を表示します。 |
| 19  | 巻（号）  | 巻（号）が表示されます。   |
| 20  | 本文ファイル   | 本文ファイルの有無を表示します。  |
| 21  | 著者  | 著者名を表示します。   |
| 22  | 出版年月日   | 出版年月日を表示します。   |
| 23  | 関連リンク   | 関連有りの場合クリックすると詳細が表示されます。   |
| 24  | 資金別 | 助成機関名、研究課題名を表示します。 |

表11-5 アイテム一覧（アイテムリスト右部分の説明）
![](media/media/image355.png)

| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 25  | アクセス数 | アイテムのアクセス数が表示されます。 |
| 26  | ダウンロード数 | ダウンロード数を表示します。 |
| 27  | 資源タイプ   | 資源タイプが表示されます。   |
| 28  | ステータス | OAアシストのステータスと連携しステータスを表示します。 |
| 29-1  | フィードバックメールなし   | フィードバックメールの有無を表示します。   |
| 29-2  | フィードバックメールあり   | フィードバックメールの有無を表示します。   |
| 30  | DOI | リンクをクリックすると詳細ページに遷移します。 |
| 31  | アイテム編集   | アイテム編集画面に遷移します。   |

表11-6 アイテム一覧（関連と下部の説明）
![](media/media/image319.png)

| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 32  | 関連タイプ   | 関連のタイプが表示されます。   |
| 33  | 関連タイトル | 関連のタイトルが表示されます。 |
| 34  | 関連URL   | 関連のURLが表示されます。   |
| 35  | ページング前 | 表示されている前のページが表示されます。 |
| 36  | ページ数  | ページ数を表示します。   |
| 37  | ページング次 | 表示されている次のページが表示されます。 |

表11-7 アイテム一覧（絞込み表示の説明）
![](media/media/image306.png)

| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 38  | 資源タイプラベル | 絞り込みしたい項目をチェックボックスで選択できます。 |
| 39  | 査読ラベル   | ありなしの選択をできます。   |
| 40  | 論文関連ラベル   | ありなしの選択をできます。   |
| 41  | 根拠データへの関連   | ありなしの選択をできます。  |
| 42  | 資金別情報・助成機関名ラベル | 絞り込みしたい項目をチェックボックスで選択できます。 |
| 43  | 資金別情報・研究課題名ラベル   | 絞り込みしたい項目をチェックボックスで選択できます。   |
| 44  | 本文ファイルラベル | ありなしの選択をできます。 |
| 45  | お気に入りラベル  | ありなしの選択をできます。   |
| 46  | 資源タイプ   | 項目をチェックボックスで選択できます。   |
| 47  | 査読有無   | ありなしの選択をできます。  |
| 48  | 論文関連の有無 | ありなしの選択をできます。 |
| 49  | 根拠データへの関連   | ありなしの選択をできます。   |
| 50  | ツールチップ | 省略された文字をツールチップで表示できます |
| 51  | 資金別情報・助成機関名有無 | 項目をチェックボックスで選択できます。 |
| 52  | 資金別情報・研究課題名有無  | 項目をチェックボックスで選択できます。   |
| 53  | 本文ファイル有無 | ありなしの選択をできます。 |
| 54  | お気に入り有無   | ありなしの選択をできます。   |
| 55  | 絞込 | 絞込みを表示します。 |
| 56  | クリア   | 絞込み条件をクリアします。   |
| 57  | 保存 | 選択した絞り込み条件を保存します。 |
| 58  | リセット   | 絞込み条件をリセットします。   |
...
| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 59  | 選択アイテム出力 | チェックボックスで選択されているアイテムリストのみを出力します。 |
| 60  | 全て出力   | 表示されているアイテムを全て出力します。   |
| 61  | キャンセル   | アイテム出力の処理をキャンセルします。   |
...
| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 64  | 検索入力 | アイテムリストからDOI,タイトル、雑誌名、会議名、資金名を検索します。 |
...
| -- | ------ | ----------- |
| 1  | DOI入力   | DOIを入力します。   |
| 2  | 取得ボタン   | 入力されたDOIを取得し、成功するとラジオボタンが活性化します。   |
| 3  | DOI取得元   | メタデータを取得するラジオボタンを選択します。   |
| 4  | ファイル名 | ファイルをアップロードすると表示され登録者が編集もできます。 |
| 5  | メタデータ   | 取得時に設定されますが、編集もできます。   |
| 6  | OAポリシー  | OAポリシーを取得します。   |
| 7  | アイテムの登録先インデックス  | アイテムの登録先インデックスを選択します。   |
| 8  | 登録 | リポジトリ設定に応じて、ワークフロー経由か直接登録で登録ができます。 |
