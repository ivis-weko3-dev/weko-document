...
3.  「![](media/media/image304.png)」リンクをクリックすると別タブでポリシー情報を確認できる。
   ※別途登録者用ワークスペースで論文登録でも表示
...
> 図 5‑50入力項目が既に登録済の場合の重複チェックメッセージ

  - > 識別子、タイトル、リソースタイプ、著者を入力した場合、登録済のアイテムであれば警告メッセージが表示されます。
    > メッセージの下に重複しているアイテムの詳細ページを表示しリンクを押下すると別タブでアイテムの詳細を確認できます。
