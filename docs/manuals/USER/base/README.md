...
| 12  | チェックボックス | アイテムリストを一括選択します。 |
| 13  | チェックボックス   | 選択するとアイテム出力ができます。   |
| 14  | 既読アイコン | 既読、未読を選択できます。 |
| 15  | お気に入りアイコン   | お気に入りを選択できます。   |
...
| 27  | リソースタイプ   | リソースタイプが表示されます。   |
| 28  | ステータス | OAアシストのステータスと連携しステータスを表示します。 |
| 29  | フィードバックメール   | フィードバックメールの有無を表示します。   |
...
| 項番 | 項目     | 説明          |
| -- | ------ | ----------- |
| 38  | リソースタイプラベル | 絞り込みしたい項目をチェックボックスで選択できます。 |
