...
1.   自動送信を行いたい機関をチェックします。<br>
複数の機関を一括で選択することができます。
...
323. サイトライセンスの項目を入力します。<br>
    ［+その他の入力行］をクリックすると「IPアドレスの範囲」の入力行が追加されます。<br>
    削除ボタンで「ipアドレスの範囲」を個別に削除することができます。<br>「ipアドレスの範囲」は最低1件の入力が必要です。<br>
