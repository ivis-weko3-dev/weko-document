...
1.   自動送信したい機関をチェックします。一括選択することができます。
...
1.   手動送信したい機関をチェックします。一括選択することができます。
...
323. サイトライセンスの項目を入力します。［+その他の入力行］をクリックすると入力できる「ipアドレスの範囲」が増えます。削除ボタンで「ipアドレスの範囲」を個別に削除することができます。「ipアドレスの範囲」は最低1つ入力する必要があります。不正な数字を入力するとエラーメッセージが表示されます
...
326. ［保存］をクリックします。
     ...
     設定が保存されます。正しくない範囲を入力するとエラーメッセージが表示されます。
