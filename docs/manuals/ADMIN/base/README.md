...
<p>※学認経由でのログイン時に付与されたGakuNin mAPグループは内部的にロールとして扱われます。</p></td>
</tr>
<tr class="odd">
<td>投稿権限</td>
...
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image483.png)
...
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image484.png)
...
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image485.png)
